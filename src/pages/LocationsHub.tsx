            ...
            <div className="max-w-3xl mx-auto text-center flex flex-col items-center">
              ...
              <div className="relative max-w-xl w-full mx-auto">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3.5 rounded-xl bg-white/10 border border-white/20 text-white placeholder-slate-400 text-sm focus:outline-none focus:ring-2 focus:ring-purple-400 backdrop-blur-md transition-all"
                />
                {searchQuery && (
                  <button
                    onClick={() => setSearchQuery('')}
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-purple-300 bg-white/10 px-2 py-1 rounded hover:bg-white/20 transition-colors"
                  >
                    Clear
                  </button>
                )}
