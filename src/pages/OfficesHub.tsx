...
export const OfficesHub: React.FC = () => {
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-slate-950 via-[#1a0733] to-slate-900 text-white pt-12 pb-20 overflow-hidden">
      ...
      <section className="py-16 md:py-24 max-w-7xl mx-auto px-4">
        ...
        <div className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-2xl p-8 border border-purple-100 text-slate-800">
          <div className="max-w-3xl">
