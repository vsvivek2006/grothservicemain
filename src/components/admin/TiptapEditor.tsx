  ...
  const editor = useEditor({
    ...
    extensions: [
      ...
      LinkExtension.configure({
        openOnClick: false,
        HTMLAttributes: {
          class: "text-purple-400 font-semibold underline decoration-purple-500/70 underline-offset-4 hover:text-yellow-400 hover:decoration-yellow-400 transition-colors cursor-pointer",
        },
      }),
