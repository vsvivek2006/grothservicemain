  ...
  return (
    <Card className="flex flex-col h-full group hover:border-purple-300 relative overflow-hidden">
      ...
      <div className="mb-5 flex items-center gap-4">
        <div className={`w-14 h-14 rounded-xl bg-gradient-to-tr ${highlightColor} flex items-center justify-center text-white shadow-md group-hover:scale-105 transition-transform duration-300 shrink-0`}>
      ...
      <Link
        to={path}
        className="inline-flex items-center gap-2 text-sm font-semibold text-purple-600 hover:text-purple-700 mt-auto pt-2 group-hover:translate-x-1 transition-transform"
      >
