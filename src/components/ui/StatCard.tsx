...
export const StatCard: React.FC<StatCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 via-purple-700 to-indigo-600 mb-2">
        {value}
      </div>
