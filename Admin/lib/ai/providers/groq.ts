    ...
    messages: [
      {
        role: "system",
        content:
          "You are an expert SEO blog director and master copywriter. Output strictly valid JSON matching the requested schema. The content field MUST be clean, valid semantic HTML with rich visual hierarchy (h2, h3, p, ul, ol, li, strong, blockquote). Never output markdown code blocks or commentary around the JSON.",
      },
      {
        role: "user",
        content: prompt,
